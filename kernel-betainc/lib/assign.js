...
let log1p = x => Math.log(1+x)
let expm1 = x =>  Math.exp(x)-1
let asin = Math.asin
let sqrt = Math.sqrt
let exp = Math.exp
let pow = Math.pow
...
var beta = require( './beta/index.js' );
...
var MAX_FLOAT64 = 1.7976931348623157e+308;
var MIN_FLOAT64 = 2.2250738585072014e-308;
var MAX_INT32 =  2147483647|0;
